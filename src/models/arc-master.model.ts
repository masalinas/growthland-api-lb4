...
@model({
  settings: {idInjection: false, mssql: {schema: 'PUBLISHER', table: 'ARC_MASTER'}}
})
export class ArcMaster extends Entity {
  @property({
    type: 'number',
    required: true,
    precision: 19,
  ...
  @property({
    ...
    precision: 19,
    scale: 0,
    mssql: {columnName: 'ID_ORDEN_TRABAJO_LINEA', dataType: 'bigint', dataLength: null, dataPrecision: 19, dataScale: 0, nullable: 'YES'},
  })
  ...
  constructor(data?: Partial<ArcMaster>) {
    super(data);
  }
}

export interface ArcMasterRelations {
  // describe navigational properties here
}

export type ArcMasterWithRelations = ArcMaster & ArcMasterRelations;
