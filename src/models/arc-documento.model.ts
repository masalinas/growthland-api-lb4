...
@model({
  settings: {idInjection: false, mssql: {schema: 'PUBLISHER', table: 'ARC_DOCUMENTO'}}
})
export class ArcDocumento extends Entity {
  @property({
    type: 'number',
    required: true,
    precision: 19,
  ...
  @property({
    type: 'string',
    length: 100,
    mssql: {columnName: 'COD_DOCUMENTO_EXT', dataType: 'varchar', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'YES'},
  })
  codDocumentoExt?: string;
  ...
  constructor(data?: Partial<ArcDocumento>) {
    super(data);
  }
}

export interface ArcDocumentoRelations {
  // describe navigational properties here
}

export type ArcDocumentoWithRelations = ArcDocumento & ArcDocumentoRelations;
